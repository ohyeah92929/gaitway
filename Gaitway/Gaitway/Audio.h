...
extern int inst_idx1;
extern int inst_idx2;
extern int inst_idx3;
extern int note_idx;
...
extern SONG songRL; // song when a user is tilted to left or right
extern SONG songF; // song when a user is tilted falling forward
extern SONG songB; // song when a user is tilted falling backward
extern SONG* songCurr; // song playing currently
